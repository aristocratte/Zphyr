...
- Source artifact: `/Users/aris/Documents/VoiceProject/Zphyr/Evals/reports/seed_split_postft_v2_round4_v2_validated_test_advanced_L2.json`
- Total examples: `167`
- WER: `0.2551`
- CER: `0.1087`
...
- Protected term accuracy: `61/78` (`78.2%`)
- Hard negative pass rate: `1/14` (`7.1%`)
- Translation violations: `0`
- Reasoning tag contamination: `0`
- Rewrite stage ran: `166/167` (`99.4%`)
- Mean latency: `258.3 ms`
...
| lists | 0.4556 | 0.3178 | 21 |
| multilingual | 0.1391 | 0.0263 | 24 |
| prose | 0.1878 | 0.0303 | 25 |
| short | 0.3090 | 0.1467 | 24 |
| technical | 0.2241 | 0.0657 | 30 |
